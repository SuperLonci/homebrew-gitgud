class GitGud < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/SuperLonci/git-gud/releases/download/v1.0.1/git-gud-macos-arm64"
    ...
    url "https://github.com/SuperLonci/git-gud/releases/download/v1.0.1/git-gud-macos-amd64"
    ...
    url "https://github.com/SuperLonci/git-gud/releases/download/v1.0.1/git-gud-linux"
